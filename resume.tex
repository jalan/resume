...
\begin{jobhead}
\textbf{Senior Software Developer}, ActiveState && (remote) ~~ 2019--~~~~~~ \\
\end{jobhead}
\begin{bullets}
Creating a next-generation dependency resolution system that works across ecosystems and on multiple platforms. \\
Maintaining an inventory of software packages for users to create custom runtimes. \\
Maximizing observability via metric reporting, distributed tracing, and careful logging. \\
\end{bullets}

\begin{jobhead}
\textbf{Senior Backend Engineer}, Percolate && Denver, CO ~~ 2019\enspace~~~~~~ \\
\end{jobhead}
\begin{bullets}
Integrated with Okta to provide our users with seamless access to external apps. \\
Maintained and extended core data models (users, roles, and capabilities). \\
\end{bullets}
...
Implemented the Relative Citation Ratio, a metric for assessing impact of scientific articles. \\
\end{bullets}
